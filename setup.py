...
setup(
    ...
    package_dir={'': 'src'},
    long_description=
        "The Barbados threadsnake (Tetracheilostoma carlae)"
        "is the smallest known snake. Combine with OOP to get"
        "Barbadoop, a tiny example of using Python with C++",
    ext_modules=[CMakeExtension("barbadoop/barbadoop")],
